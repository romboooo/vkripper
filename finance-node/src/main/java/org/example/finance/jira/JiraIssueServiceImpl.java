...
import org.example.banking.jca.JiraConnection;
import org.example.banking.jca.JiraConnectionFactory;
...
public class JiraIssueServiceImpl implements JiraIssueService {
    ...
    public JiraIssueResult createPaymentProblemIssue(
        ...
        String description = """
                ...
                This issue was created automatically by banking-node through JCA adapter.
                """.formatted(
                paymentId,
                orderId,
                userId,
